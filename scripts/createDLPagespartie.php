...
$DL_pages = [
    'publication-directeur-du-labo'        => 'Publication Directeur du Labo',
    'ajouter-une-publication-directeur-du-labo' => 'Ajouter une publication Directeur du Labo',
    'details-publication-directeur-du-labo'     => 'Détails publication Directeur du Labo',
    'contacts-directeur-du-labo'           => 'Contacts Directeur du Labo',
];
...
foreach ($DL_pages as $slug => $title) {
    ...
    if (!$post_id) {
        // Créer la page via API WP (meilleure pratique)
