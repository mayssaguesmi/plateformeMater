...
function validateStep1() {
  ...
  const requiredFields = [
    'nom', 'prenom', 'nom-arabe', 'prenom-arabe', 'nationalite',
    , 'lieunaissance','lieunaissanceAr', 'email',
     'telephone', 'adresse','adresseAr',
    'nationalite','nationnaliteAr'
    , 'datenaissance' ,'code-postal',
    'delegation','delegationAr','gouvernorat','gouvernoratAr', 
  ];
