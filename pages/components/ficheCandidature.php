<div class="content-wrapper">
  ...
  <div class="box" draggable="true">
    ...
    <ul>
      ...
      <li><strong>Dernière connexion :</strong> </li>
  ...
  <div class="box" draggable="true">
    ...
    <ul>
      ...
      <li><strong>État de validation :</strong> _</li>
        ...
        <tr>
          ...
          <!--<tbody>
            ...
            <td>—</td>
                    ...
                    <tr>
                      <td>2022/2023</td><td>FST</td><td>Chimie Fine</td><td>Licence Nationale</td><td>2</td><td>Rattrapage</td><td>—</td><td class="notes-cell">
              <div><strong>MGSP</strong> = 15.76</div>
              <div><strong>NC</strong> = 60</div>
            </td>
            <td>—</td>
                    ...
                    <tr>
                      <td>2021/2022</td><td>FST</td><td>Chimie Fine</td><td>Licence Nationale</td><td>1</td><td>Principale</td><td>—</td><td class="notes-cell">
              <div><strong>MGSP</strong> = 15.76</div>
              <div><strong>NC</strong> = 60</div>
            </td>
            <td>—</td>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  .then(result => {
    if (result.status === 'success' && result.data.length > 0) {
      const c = result.data[0]; // on prend la première candidature
      ...
      dragZone.innerHTML = `
        <div class="box" draggable="true">
          ...
          <ul>
            ...
            <li><strong>Nom et prénom :</strong> <span>${c.etudiant}</span></li>
            <li><strong>E-mail :</strong> <span>${c.email || '—'}</span></li>
            <li><strong>Sexe :</strong> <span>${c.sexe || '—'}</span></li>
            <li><strong>Situation :</strong> <span>${c.statut_etudiant}</span></li>
            <li><strong>Dernière connexion :</strong> <span>${c.last_login || '—'}</span></li>
        ...
        <div class="box" draggable="true">
          <h3>Bac</h3>
          <ul>
            <li><strong>Session :</strong> <span>${c.session || '—'}</span></li>
            <li><strong>Année :</strong> <span>${c.annee_bac || '—'}</span></li>
            <li><strong>Mention :</strong> <span>${c.mention || '—'}</span></li>
            <li><strong>Moyenne :</strong> <span>${c.moyenne || '—'}</span></li>
            <li><strong>Diplôme :</strong>
        ...
        <div class="box" draggable="true">
          ...
          <ul>
            ...
            <li><strong>Gouvernorat :</strong> <span>${c.gouvernorat || '—'}</span></li>
            <li><strong>Ville :</strong> <span>${c.ville || '—'}</span></li>
            <li><strong>Rue :</strong> <span>${c.rue || '—'}</span></li>
            <li><strong>Code postale :</strong> <span>${c.code_postal || '—'}</span></li>
          </ul>
        </div>
        ...
        <div class="box" draggable="true">
          ...
          <ul>
            ...
            <li><strong>Établissement :</strong> <span>${c.etablissement || '—'}</span></li>
            <li><strong>Score :</strong> <span>${c.score ?? '—'}</span></li>
            <li><strong>Statut dossier :</strong> <span>${c.statut_dossier}</span></li>
            <li><strong>État de validation :</strong> <span>${c.validation || '_'}</span></li>
            <li><strong>Statut :</strong> <span>${c.statut_final || 'Admis'}</span></li>
          </ul>
        </div>
      `;
    } else {
      console.warn('Aucune candidature trouvée.');
    }
  })
  .catch(error => {
...
document.addEventListener('DOMContentLoaded', () => {
 ...
 const urlParams = new URLSearchParams(window.location.search);
  ...
  if (!candidatureId) {
    console.warn('Aucun ID de candidature trouvé dans l’URL.');
    return;
  }

  // 🔹 Chargement de la fiche candidature
  fetch(`${PMSettings.apiUrlDossierCandidature}/${candidatureId}`, {
    ...
    .then(result => {
      ...
      const bacBlock = `
        <div class="box" draggable="true">
          <h3>Bac</h3>
          <ul>
            <li><strong>Session :</strong> <span>${bac.session || '—'}</span></li>
            <li><strong>Année :</strong> <span>${bac.annee_academique || '—'}</span></li>
            <li><strong>Mention :</strong> <span>${bac.mention || '—'}</span></li>
            <li><strong>Moyenne :</strong> <span>${bac.moyenne || '—'}</span></li>
            <li><strong>Diplôme :</strong> ${
      ...
      const adresseBlock = `
        <div class="box" draggable="true">
          ...
          <ul>
            ...
            <li><strong>Gouvernorat :</strong> <span>${adresse.gouvernorat_fr || '—'}</span></li>
            <li><strong>Ville (délégation) :</strong> <span>${adresse.delegation_fr || '—'}</span></li>
            <li><strong>Adresse (Rue) :</strong> <span>${adresse.adresse_fr || '—'}</span></li>
            <li><strong>Code postale :</strong> <span>${adresse.code_postal || '—'}</span></li>
          </ul>
        </div>
      `;
      ...
      const criteres = result.data.criteres_score || [];
        ...
        dragZone.innerHTML = `
          <div class="box" draggable="true">
            ...
            <ul>
              ...
              <li><strong>Nom et prénom :</strong> <span>${c.nom} ${c.prenom}</span></li>
              <li><strong>E-mail :</strong> <span>${c.email1 || '—'}</span></li>
              <li><strong>Téléphone :</strong> <span>${c.telephone || '—'}</span></li>
              <li><strong>Situation :</strong> <span>${c.statut_etudiant}</span></li>
              <li><strong>Date de soumission :</strong> <span>${c.date_soumission || '—'}</span></li>
            </ul>
          </div>
          ...
          <div class="box" draggable="true">
            <h3>Master</h3>
            <ul>
              <li><strong>Intitulé :</strong> <span>${c.intitule_master}</span></li>
              <li><strong>Niveau :</strong> <span>${c.niveau}</span></li>
              <li><strong>Année universitaire :</strong> <span>${c.annee_universitaire}</span></li>
              <li><strong>Score :</strong> <span>${c.score ?? '—'}</span></li>
        ...
        const parcours = result.data.parcours || [];
          ...
          if (parcours.length === 0) {
            tbody.innerHTML = '<tr><td colspan="9">Aucun parcours enregistré.</td></tr>';
          } else {
          ...
          parcours.forEach(p => {
            ...
            const row = `
              <tr>
                <td>${p.annee_academique || '—'}</td>
                <td>${p.nom_universite || '—'}</td>                  
   ...
   // Attendre que les statuts soient chargés (petit délai)
        setTimeout(() => {
...
function getNiveauParCycleEtAnnee(cycle, anneeAcademique) {
  ...
  if (!cycle || isNaN(annee)) return '—';

  cycle = cycle.toLowerCase();

  if (cycle.includes('licence')) {
    return annee >= 1 && annee <= 3 ? `L${annee}` : '—';
  }

  if (cycle.includes('maitrise') || cycle.includes('maîtrise')) {
    return annee >= 1 && annee <= 4 ? `L${annee}` : '—';
  }

  if (cycle.includes('mastère') || cycle.includes('master')) {
    if (annee >= 1 && annee <= 3) return `L${annee}`; // pré-M1
    if (annee === 4) return 'M1';
    if (annee === 5) return 'M2';
    return '—';
  }

  if (cycle.includes('ingenieur') || cycle.includes('ingénieur')) {
    return annee >= 1 && annee <= 5 ? `I${annee}` : '—';
  }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!candidatureId) {
    alert("❌ ID de candidature introuvable dans l'URL.");
    return;
  }

  // Délégation d'événement : capter les clics sur le conteneur
