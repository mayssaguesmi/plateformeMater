...
require_once 'wp-content/plugins/plateforme-master/config/roles.php';
...
<head>
  <meta charset="UTF-8">
  <title>reservation et planning</title>
      ...
      <div class="col-md-9 col-lg-10 p-0">
        ...
        <?php include 'wp-content/plugins/plateforme-master/pages/components/Dashboard-Bar.php'; ?>
         ...
         <div class="content p-4">
                    ...
                    <?php include 'components/stats-reservation.php'; ?>


                    <?php include 'components/table-reservation.php'; ?>
