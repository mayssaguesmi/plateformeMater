...
<head>
    ...
    justify-content:space-between;
    gap:16px;
    margin-bottom:16px; /* léger espace avant la zone de recherche/filtres */
  }
  .equipments-title{
    font-weight:700;
    font-size:20px;
...
<?php
  ...
  $mon_labo_url = esc_url( site_url('/uscr_details_equipements') );
?>
...
<img src="/wp-content/plugins/plateforme-master/imagesED/10550857.png" alt="">
  ...
  <?php if (!in_array('um_chercheur', $roles)) { ?>
    <button class="btn-statut header" id="openEquipementModal">Ajouter équipement</button>
  <?php } ?>
</div>
...
const DETAILS_BASE_URL = ($('#equipementsTable').data('details-url') || '/uscr_details_equipements').toString();
