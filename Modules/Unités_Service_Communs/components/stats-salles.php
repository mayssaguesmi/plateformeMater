<div class="statistiques-wrapper">
    ...
    <div class="stats-grid">
        ...
        <div class="left-stats">
            <div class="stat-box">
                <span class="label">Nombre total de salles</span>
                <span class="value">15</span>
            </div>
            <div class="stat-box">
                <span class="label">% de salles disponibles</span>
        ...
        <div class="right-graph">
            <div class="graph-header">
                <h4>Utilisation par type de salle</h4>
...
<script>
const labels = ['Microscope Électronique', 'Serveur HPC', 'Spectromètre RMN'];
