...
<div class="content-wrapper">
    ...
    <div class="card full-width">
        ...
        <ul class="styled-list">
            <li><strong>Logo et Dénomination :</strong><span><img
                        src="http://wordpress.test:8080/wp-content/plugins/ultimate-member/assets/img/default_avatar.jpg"
                        alt="photo"> <strong style="color: #2A2916;"> LSAMA – Laboratoire de Systèmes
    ...
    <div class="card full-width">
        <h3>Objectifs et thématiques<a href="#" id="modifyInfoBtn"><i class="fa-regular fa-pen-to-square"
                    style="color: #b60303;"></i></a></h3>
        <ul class="styled-list">
