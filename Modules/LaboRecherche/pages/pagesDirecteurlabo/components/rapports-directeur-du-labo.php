        ...
        <div class="sb-body">
            <div class="form-stack">
                ...
                <div class="field inp-wrap field--date" id="dateField">
                    <!-- Changed input type to 'date' for better user experience -->
    ...
    (function() {
        ...
        function filterRows() {
            ...
            rows.forEach(tr => {
                ...
                const isVisible = textContent.includes(q);
            ...
            // Show or hide the no results message and the pagination buttons
            if (noResultsMessage) {
            ...
            // Re-render the table with pagination after filtering
            goToPage(1);
        }
