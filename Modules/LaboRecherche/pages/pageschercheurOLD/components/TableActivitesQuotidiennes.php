    ...
    <div class="popup-container" id="popupContainerObjectifs">
        ...
        <form class="popup-form">
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="membreConcerne">
                        ...
                        <option value="">Houssem Lahmar</option>
                        <option value="">Dr. M. Abdelkefi</option>
                        <option value="">Dr. C. Hadj Kacem</option>
                        <option value="">Dr. M. Zghari</option>
                        <option value="">Marwa Trabelsi</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <input type="text" id="activiteDate" placeholder="">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <input type="text" id="activiteHeure" placeholder="">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="typeActivite">
                        <option value="">Sélection..</option>
                        <option value="">Réunion D’avancement Avec Doctorants</option>
                        <option value="">Prétraitement EEG Patient #4</option>
                        <option value="">Test Module D'acquisition Embarqué</option>
                        <option value="">Rédaction Article Section 2.3</option>
                        <option value="">Réunion Coordination Projet AR-UTM</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Connect the "Ajouter une activité" button to the modal
