...
<div class="statistiques-wrapper" id="bloc-stats-combine" data-lab-id="19">
    ...
    <div class="stats-grid">
        ...
        <div class="left-stats">
            <div class="stat-box">
                <span class="label">Nombre total des<br> enseignants permanant</span>
                <span class="value"></span>
            </div>
            <div class="stat-box">
                <span class="label">Nombre total <br>des doctorants</span>
                <span class="value"></span>
            </div>
        </div>
        ...
        <div class="right-graph bar-chart-section"
            style="    align-items: flex-start; max-width: unset; width: 100%; display: inline; gap: 1rem;">
            <div class="graph-header" style="flex-shrink: 0;">
                <h4>Nombre total des chercheurs par année</h4>
            </div>
