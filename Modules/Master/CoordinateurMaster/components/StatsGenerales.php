...
$labels     = ['Nbr. Inferieur Au Max', 'Aucun Étudiant', 'Nbr. Max atteint'];
$dataValues = [24, 20, 56]; // en %
$colors     = ['#f6d061', '#e3b3b0', '#a5a481'];
?>
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box stripe-red">
        <span class="label">Total des <br>Etudiants</span>
        <span class="value" id="totalcandidatures"><?php echo (int)$totalCandidatures; ?></span>
      </div>
      <div class="stat-box stripe-red">
        <span class="label">Total des <br>encadrants</span>
