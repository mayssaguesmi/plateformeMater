        ...
        <table class="parcours-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><strong>95 000</strong></td>
                    <td class="text-right"><strong>55 000</strong></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    async function loadFinancementSource(idsource) {
        try {
            const res = await fetch(
                `${window.PMSettings.restUrl}plateforme-recherche/v1/financement/source?idsource=${idsource}`, {
                headers: {
