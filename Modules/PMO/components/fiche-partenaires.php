...
<div class="content-wrapper">
    ...
    <div class="card full-width">
        <h3>Activités réalisées avec ce partenaire</h3>
        <table class="parcours-table" id="tableactivitesrealisees">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Type d'activité</th>
        ...
        <div id="rg-activites-empty" style="margin-top:8px; text-align: center;">Aucune activité enregistrée</div>
    </div>
...
#tableactivitesrealisees {
    border: none !important;
    border-collapse: collapse;
    box-shadow: none !important;
}

#tableactivitesrealisees th {
    border: 0px solid #EBE9D7;
    text-align: center;
}

#tableactivitesrealisees td {
    border: 1px solid #EBE9D7;
    text-align: center;
}

#tableactivitesrealisees thead {
    border: none !important;
    position: static;
    transform: translateY(-15px);
}

#tableactivitesrealisees tbody tr:first-child td:first-child {
    border-top: 1px solid #EBE9D7 !important;
}
...
#tableactivitesrealisees thead tr:first-child th:first-child {
    border-top-left-radius: 12px;
    border-bottom-left-radius: 12px;
}

#tableactivitesrealisees thead tr:first-child th:last-child {
    border-top-right-radius: 12px;
    border-bottom-right-radius: 12px;
}

#tableactivitesrealisees tbody tr:last-child td:first-child {
    border-bottom-left-radius: 12px;
}

#tableactivitesrealisees tbody tr:last-child td:last-child {
    border-bottom-right-radius: 12px;
}
...
#tableactivitesrealisees tbody tr:first-child td:last-child {
    border-top-right-radius: 12px;
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        document.querySelector(".card:nth-of-type(1) ul").innerHTML = `
            ...
            <li><strong>Site web :</strong> ${reseau.site_web
