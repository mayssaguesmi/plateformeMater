...
<div class="content-block">
    <div class="header-bar">
        <h2 class="dashboard-sub-title">
            <img src="https://placehold.co/38x38/cccccc/333333?text=Icon" alt="Icon"
                style="width: 38px; margin-right: 8px; vertical-align: middle; font-weight: blod;">
            Agenda des soutenances à venir
        </h2>
    ...
    <table id="candidaturesTable" class="styled-table display">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <span class="badge badge-success"> <i class="fa-regular fa-circle-check"
                            style="color: #0E962D; padding-right:5px;"></i>Confirmée</span>
                </td>
                <td>Oui</td>
                <td>
                    <div class="actions">
            ...
            <tr>
                ...
                <td><span class="badge badge-warning"> <i class="fa-regular fa-circle-check"
                            style="color: #FFD54F; padding-right:5px;"></i>En attente</span></td>
                <td>Non</td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
            ...
            <tr>
                ...
                <td><span class="badge badge-danger"> <i class="fa-regular fa-circle-check"
                            style="color: #960e0eff; padding-right:5px;"></i>Non planifiée</span>
                </td>
                <td>Non</td>
                <td>
                    <div class="actions">
...
<!-- Modal HTML from the second code snippet -->
    ...
    <div class="popup-container" id="popupContainerObjectifs">
        ...
        <form class="popup-form">
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="doctorant" name="doctorant">
                        <option value="" disabled selected>Doctorant</option>
                        <option value="aymen">Aymen Ben Salah</option>
                        <option value="fatma">Fatma Jouinir</option>
                        <option value="anis">Anis Boughanmi</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
            ...
            <div class="form-group" style="display: flex; gap: 10px;">
                <div style="flex: 1;">
                    ...
                    <div class="input-with-icon">
                        <input type="text" id="date" name="date" placeholder="Date" class="date-input">
                ...
                <div style="flex: 1;">
                    ...
                    <div class="input-with-icon">
                        <input type="text" id="heure" name="heure" placeholder="Temps">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="jury1" name="jury1">
                        <option value="" disabled selected>Jury 1</option>
                        <option value="jury_member1">Membre Jury 1</option>
                        <option value="jury_member2">Membre Jury 2</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <select id="jury2" name="jury2">
                        <option value="" disabled selected>Jury 2</option>
                        <option value="jury_member3">Membre Jury 3</option>
                        <option value="jury_member4">Membre Jury 4</option>
                    </select>
                    <i class="fas fa-chevron-down icon right-icon"></i>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (openModalBtn) {
        openModalBtn.addEventListener('click', openmodalObjectifs);
    }

    // Event listener to close the modal if clicking outside the popup container
    if (modal && popup) {
        modal.addEventListener("click", function(e) {
            // If the click is on the overlay but not the container, close it
