        ...
        <div class="filter-inputs">
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Statut Du Rapport</option>
                    <option>✔️ Soumis</option>
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Année Universitaire</option>
                    <option>2023</option>
                    <option>2024</option>
                    <option>2025</option>
                </select>
                ...
                <td>
                    <div class="actions">
                        ...
                        <div class="dropdown-menu">
                            <a href="#"><i class="fa-solid fa-pencil"></i> Compléter</a>
                            <a href="/fiche-d-evaluation-annuelle_directeurth"><i class="fa-regular fa-eye"></i>
                                Consulter</a>
                            <a href="#"><i class="fa-regular fa-file-lines"></i> Voir PDF</a>
                        </div>
                    </div>
                </td>
            </tr>
