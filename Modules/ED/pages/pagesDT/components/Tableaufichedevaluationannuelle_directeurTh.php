<div class="content-block">
    ...
    <table id="candidaturesTable" class="styled-table display">
        ...
        <tbody>
            <tr>
                <td>Progrès scientifique global</td>
                <td class="body">
                    <div class="value-stepper">
                        <span class="stepper-value" id="stepper-value">3</span>
                        <div class="stepper-arrows">
                            <button class="arrow-up" id="stepper-up" aria-label="Increase value"><i
                                    class="fa-solid fa-angle-up"></i></button>
                            <button class="arrow-down" id="stepper-down" aria-label="Decrease value"><i
                                    class="fa-solid fa-angle-down"></i></button>
                        </div>
                    </div>
                </td>
                <td>Avancement satisfaisant sur le 2e objectif</td>
                <td><i class="fa-regular fa-comment-dots"></i></td>
            </tr>
            <tr>
                <td>Méthodologie et rigueur</td>
                <td class="body">
                    <div class="value-stepper">
                        <span class="stepper-value" id="stepper-value">3</span>
                        <div class="stepper-arrows">
                ...
                <td>Méthodes améliorées depuis le dernier semestre</td>
                <td><i class="fa-regular fa-comment-dots"></i></td>
            </tr>
            <tr>
                <td>Production scientifique</td>
                <td class="body">
                    <div class="value-stepper">
                        <span class="stepper-value" id="stepper-value">3</span>
                        <div class="stepper-arrows">
                ...
                <td>Une communication locale, mais pas de publication encore</td>
                <td><i class="fa-regular fa-comment-dots"></i></td>
            </tr>
            <tr>
                <td>Régularité des échanges et réunions</td>
                <td class="body">
                    <div class="value-stepper">
                        <span class="stepper-value" id="stepper-value">3</span>
                        <div class="stepper-arrows">
                ...
                <td>Très bonne interaction</td>
                <td><i class="fa-regular fa-comment-dots"></i></td>
            </tr>
            <tr>
                <td>Respect du calendrier et livrables</td>
                <td class="body">
                    <div class="value-stepper">
                        <span class="stepper-value" id="stepper-value">3</span>
                        <div class="stepper-arrows">
                ...
                <td>Légers retards sur les livrables écrits</td>
                <td><i class="fa-regular fa-comment-dots"></i></td>
            </tr>
        </tbody>
    </table>
    <div class="sommeTotale">
        <div class="left-side">Note globale automatique :</div>
        <div class="right-side">3.4 / 5</div>
    </div>
</div>
...
.value-stepper {
    ...
    align-items: center;
    /* background: #F8F7F0; */
    /* A slightly off-white, warm gray */
...
.stepper-arrows .arrow-up {
    padding-bottom: 2px;
    border-bottom: 1px solid #d1cfc6;
}

.stepper-arrows .arrow-down {
    padding-top: 2px;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const upButton = document.getElementById('stepper-up');
    const downButton = document.getElementById('stepper-down');
    ...
    downButton.addEventListener('click', function() {
        let currentValue = parseInt(valueEl.textContent, 10);
        // Prevent going below zero, or any other minimum you want
        if (currentValue > 0) {
            valueEl.textContent = currentValue - 1;
        }
    });
