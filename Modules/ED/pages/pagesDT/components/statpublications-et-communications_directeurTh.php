<div class="statistiques-wrapper">
    ...
    <div class="stats-grid">
        ...
        <div class="left-stats">
            <div class="stat-box">
                <span class="label">Total publications enregistrées</span>
                <span class="value">5</span>
            </div>
            <div class="stat-box">
                <span class="label">Communications scientifiques</span>
        ...
        <div class="right-graph">
            <div class="graph-header">
                <h4>Répartition par statut de validation</h4>
...
<script>
const labels = ['Publications Validées', 'Publications En Attente', 'Publications refusées'];
