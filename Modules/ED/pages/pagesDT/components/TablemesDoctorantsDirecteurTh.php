...
<div class="content-block">
    <div class="header-bar">
        <h2 class="dashboard-sub-title">
            ...
            Tableau des doctorants encadrés
        </h2>
        ...
        <div class="filter-inputs">
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Année en cours</option>
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Etat Thèse</option>
        ...
        <tbody>
            <tr>
                ...
                <td><span class="badge badge-success"> <i class="fa-regular fa-circle-check"
                            style="color: #0E962D; padding-right:5px;"></i>En cours</span></td>
                <td>_</td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
                        <div class="dropdown-menu">
                            <a href="/fiche-individuelle-du-doctorant_directeurth"><i class="fa-regular fa-eye"></i>
                                Fiche</a>
                            <a href="#"><i class="fa-solid fa-comment-dots"></i> Ajouter note</a>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><span class="badge badge-warning"> <i class="fa-regular fa-circle-check"
                            style="color: #FFD54F; padding-right:5px;"></i>Retard</span></td>
                <td>Rapport Non Déposé</td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
                        <div class="dropdown-menu">
