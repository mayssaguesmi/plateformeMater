...
<div class="content-block">
    <div class="header-bar">
        <h2 class="dashboard-sub-title">
            ...
            Tableau des réunions à venir
        </h2>
        <!-- This button will open the modal -->
        <button class="add-project-btn">Programmer une réunion</button>
    </div>
        ...
        <div class="filter-inputs">
            ...
            <div class="input-with-icon">
                <select class="filter-select">
                    <option value="" disabled selected>Type De Réunion</option>
                    <option>Soutenance</option>
                    <option>Réunion Comité</option>
    ...
    <table id="candidaturesTable" class="styled-table display">
        <thead>
            <tr>
                ...
                <th>Sujet / Dossier lié</th>
                <th>Lieu / Lien visio</th>
                <th>Statut</th>
                <th>PV</th>
                <th>Actions</th>
            </tr>
        ...
        <tbody>
            <tr>
                ...
                <td>10H00</td>
                <td>Soutenance</td>
                <td>Thèse – Ines Hamdi</td>
                <td>Salle C2 – FST</td>
                <td><span class="badge badge-success"> <i class="fa-regular fa-circle-check"
                            style="color: #0E962D; padding-right:5px;"></i>Confirmée</span></td>
                <td><img src="/wp-content/plugins/plateforme-master//imagesED/27) Icon-attach-2.png"
                        alt="27) Icon-attach-2.png" style="width: 25px;"></td>
                <td>
                    <div class="actions">
                        <button class="action-btn">...</button>
                        <div class="dropdown-menu">
                            <a href="#"><i class="fa-regular fa-eye"></i> Consulter</a>
                            <a href="#"><i class="fa-solid fa-download"></i> Télécharger PV</a>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>20/06/2025</td>
                <td>14H30</td>
                <td>Réunion Comité</td>
                <td>Suivi Thèse – Tarek B</td>
                <td>Google Meet</td>
            ...
            <tr>
                ...
                <td>09H00</td>
                <td>Séminaire</td>
                <td>IA Et Analyse De Données</td>
                <td>Confirmée</td>
                <td><span class="badge badge-success"> <i class="fa-regular fa-circle-check"
                            style="color: #0E962D; padding-right:5px;"></i>Confirmée</span></td>
                <td>_</td>
