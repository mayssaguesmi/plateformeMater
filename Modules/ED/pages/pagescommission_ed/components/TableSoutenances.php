<div class="content-block">
  <div class="header-bar">
    <h2>
      ...
      Liste des soutenances à traiter
    </h2>
  </div>
  ...
  <div class="filter-bar">
    ...
    <div class="filter-actions">
      <a href="/planifier-soutenance_comissioned/" class="btn-statut">Programmer une soutenance</a>
  ...
  <table id="candidaturesTable" class="styled-table display" style="width:100%">
    ...
    <tbody>
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              ...
              <a href="#"><i class="fa fa-calendar-plus"></i> Planifier</a>
            </div>
          </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>Non</td>
        <td><i class="fa fa-times" style="color:red;"></i></td>
        <td><span class="badge badge-danger">Non planifiée</span></td>
        <td>
          <div class="actions">
            <button class="action-btn" aria-haspopup="true" aria-expanded="false">⋮</button>
            <div class="dropdown-menu">
