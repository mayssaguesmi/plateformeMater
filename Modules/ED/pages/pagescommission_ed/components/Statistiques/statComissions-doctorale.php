<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Réunions tenues<br>cette année</span>
        </div>
      ...
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Dossiers examinés</span>
        </div>
    ...
    <div class="left-stats">
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Recommandations <br>en attente</span>
        </div>
      ...
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">PV générés</span>
        </div>
