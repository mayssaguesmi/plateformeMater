<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    <div class="left-stats">
     ...
     <div class="stat-box">
      <span class="label">Formations organisées</span>
      <span class="value">14</span>
    </div>
    <div class="stat-box">
      <span class="label">Taux moyen de <br>présence</span>
...
<script>
  const labels = ['Formation à venir', 'Formation terminées', 'Formation activées'];
