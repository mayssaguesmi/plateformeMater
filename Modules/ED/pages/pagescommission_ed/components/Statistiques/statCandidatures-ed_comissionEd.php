<div class="statistiques-wrapper">
  <div class="header-bar">
    ...
    <button class="btn-report"><i class="fa fa-rotate"></i> Générer un rapport global</button>
  </div>
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Total des <br>candidatures</span>
        </div>
      ...
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Dossiers <br> incomplets</span>
        </div>
...
<script>
  const labels = ['Accepté', 'Rejeté', 'En attente'];
