<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Soutenances traitées<br>cette année</span>
        </div>
      ...
      <div class="stat-box">
        <div class="stat-left">
          <span class="label">Jurys validés</span>
        </div>
...
<script>
  const labels = ['Validées', 'À Traiter', 'Reportées'];
