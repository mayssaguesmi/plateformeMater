<div class="content-block"> 
  <div class="header-bar">
    <h2>
      ...
      Tableau des comités de suivi actifs
    </h2>
  </div>
  ...
  <div class="filter-bar">
    <div class="filter-selectgb">
      ...
      <select class="filter-select">
        <option>État Du Comité</option>
        <option>À jour</option>
        <option>À constituer</option>
  ...
  <table id="candidaturesTable" class="styled-table display" style="width:100%">
    <thead>
      <tr>
        ...
        <th>Doctorant</th>
        <th>Spécialité</th>
        <th>Comité constitué</th>
        <th>Dernier entretien</th>
        <th>Prochain prévu</th>
        <th>Statut</th>
        <th>Rapport disponible</th>
    ...
    <tbody>
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              <a href="/fiche-de-comite-de-suivi_comissioned/"><i class="fa fa-eye"></i> Consulter</a>
      ...
      <tr>
        ...
        <td>12-02-2025</td>
        <td>—</td>
        <td><span class="badge badge-warning">À constituer</span></td>
        <td>—</td>
        <td>
          <div class="actions">
            <button class="action-btn" aria-haspopup="true" aria-expanded="false">⋮</button>
