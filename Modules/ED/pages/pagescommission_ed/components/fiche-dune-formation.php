...
<div class="content-wrapper">
  ...
  <!-- En-tête retiré (pas présent sur la maquette) -->

  <!-- 2 colonnes : Informations générales / Planning -->
  <div class="grid-container" id="dragZone">
    <div class="box" draggable="true">
      <h3>Informations générales</h3>
      <ul>
        <li><strong>Titre :</strong> <span>Rédaction scientifique avancée</span></li>
        <li><strong>Objectifs :</strong> <span>Initier à la rédaction d’articles scientifiques dans des revues indexées</span></li>
        <li><strong>Type :</strong> <span>Obligatoire</span></li>
        <li><strong>Public cible :</strong> <span>1re &amp; 2<sup>e</sup> Année</span></li>
        <li><strong>Crédits :</strong> <span>3</span></li>
      </ul>
    </div>
    ...
    <div class="box" draggable="true">
      <h3>Planning</h3>
      <ul>
        <li><strong>Date :</strong> <span>12-06-2025 à 14-06-2025</span></li>
        <li><strong>Durée :</strong> <span>6h</span></li>
        <li><strong>Lieu :</strong> <span>Amphi D</span></li>
        <li><strong>Modalité :</strong> <span>Présentiel</span></li>
        <li class="li-formateurs">
          <strong>Formateurs :</strong>
          <div class="formateurs">
            
            <span class="avatar-group">
              <img class="avatar" src="/wp-content/plugins/plateforme-master/images/ed/Groupe de masques 372.png" alt="Dr. Leïla Baccar">
              <span class="nom">Dr. Leïla Baccar</span>
            </span>

            <span class="avatar-group">
              <img class="avatar" src="/wp-content/plugins/plateforme-master/images/ed/Groupe de masques 372.png" alt="Dr. Anis Azaiez">
              <span class="nom">Dr. Anis Azaiez <small>(co-animation)</small></span>
            </span>
          </div>
        </li>
      </ul>
  ...
  <tbody>
    <tr>
      ...
      <td><span class="status-icon success"><i class="fa fa-check"></i></span> Oui</td>
      <td>Générée</td>
      <td>3</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Manel Ghomrassni</td>
      <td>4<sup>e</sup> Année</td>
      <td><span class="status-icon danger"><i class="fa fa-times"></i></span> Non</td>
      <td>–</td>
      <td>–</td>
    </tr>
    <tr>
  ...
  <div class="card full-width">
    ...
    <table class="parcours-table">
      ...
      <tbody>
        ...
        <tr>
          <td>003</td>
          <td>Support de cours (PPT / PDF)</td>
          <td>–</td>
        </tr>
        <tr>
          <td>004</td>
          <td>Attestation de validation</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" alt="pdf"></a></td>
        </tr>
      </tbody>
    </table>
