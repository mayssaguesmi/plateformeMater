<div class="content-block">
  <div class="header-bar">
    <h2>
      ...
      Tableau des formations proposées
    </h2>
  </div>
  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      <tr>
        ...
        <td>Rédaction Scientifique Avancée</td>
        <td>3</td>
        <td>Obligatoire</td>
        <td>12-06-2025 à 14-06-2025</td>
        <td>Dr. Leïla Baccar</td>
        <td>‑</td>
        <td><span class="badge badge-danger">À venir</span></td>
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              ...
              <a href="/formation-doctorale-fiche-d-une-formation-doctorale_comissioned/"><i class="fa fa-info-circle"></i> Détails</a>
            </div>
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Éthique Et Intégrité De La Recherche</td>
        <td>2</td>
        <td>Recommandée</td>
        <td>20/04/2025</td>
        <td>Dr. A. Mejri</td>
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Statistiques Appliquées</td>
        <td>2</td>
        <td>Facultative</td>
        <td>26/04/2025</td>
        <td>Pr. R. Ben Hassen</td>
        <td>23</td>
