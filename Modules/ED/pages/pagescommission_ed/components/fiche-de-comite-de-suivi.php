...
<div class="content-wrapper">
  ...
  <!-- 2 colonnes : on ne garde visuellement que la 1ère comme sur la maquette -->
  <div class="grid-container" id="dragZone">
    <div class="box" draggable="true">
      ...
      <ul>
        ...
        <li><strong>Année en cours :</strong> <span>2<sup>e</sup> année</span></li>
        <li><strong>Sujet de thèse :</strong> <span>Détection électrochimique des métaux lourds</span></li>
      </ul>
    </div>

    <!-- masqué pour coller au design (1 seule carte en haut) -->
  ...
  <div class="card full-width" style="margin-top:20px;">
    <h3>
      Composition du comité
      <button class="btn btn-outline-danger" style="float:right;">Modifier comité</button>
    </h3>
  ...
  <div class="card full-width">
    <h3>Entretien &amp; Rapport</h3>
    <table class="parcours-table">
      <tbody>
        <tr>
          <td style="width:280px; font-weight:600; color:#6E6D55;">Dernier entretien effectué :</td>
          <td>15/12/2024</td>
        </tr>
        <tr>
          <td style="font-weight:600; color:#6E6D55;">Prochain entretien prévu :</td>
          <td>20/06/2025</td>
        </tr>
        <tr>
          <td style="font-weight:600; color:#6E6D55;">Rapport de suivi :</td>
          <td>
            <div style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
              <span>rapport_suivi_ines_hamdi_2024.pdf</span>
              <a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" alt="pdf"></a>
            </div>
          </td>
        </tr>
      </tbody>
