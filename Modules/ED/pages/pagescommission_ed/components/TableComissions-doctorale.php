<div class="content-block">
  <div class="accordion-container">
    <div class="accordion-tabs">
      <button class="tab-btn active" data-tab="tab1"><img src="/wp-content/plugins/plateforme-master/images/ed/16406436.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;"> Ordre du jour (réunion à venir)</button>
      <button class="tab-btn" data-tab="tab2"><img src="/wp-content/plugins/plateforme-master/images/ed/2282469.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;">Suivi des recommandations</button>
    </div>
    ...
    <div class="accordion-content">
        ...
        <div class="table-controls">
          <div class="filter-selectgb">
            ...
            <select class="filter-select">
              ...
              <option value="Pr. Sami Trabelsi">Pr. Sami Trabelsi</option>
              <option value="Dr. Y. Messaoudi">Dr. Y. Messaoudi</option>
            </select>
            <select class="filter-select">
          ...
          <div class="filter-actions">
            <button class="icon-btn" title="Filtrer"><i class="fa fa-filter"></i></button>
            <button class="icon-btn" title="Exporter"><i class="fa fa-download"></i></button>
          </div>
        </div>
        ...
        <table class="styled-table">
          ...
          <tbody>
              ...
              <td>
                <div class="actions">
                  ...
                  <div class="dropdown-menu">
                    <a href="/fiche-reunion-comission_comissioned/"><i class="fa fa-eye"></i> Consulter</a>
                    <a href="#"><i class="fa fa-pen"></i> Modifier</a>
                    <a href="#"><i class="fa fa-download"></i> Télécharger</a>
                    <a href="#"><i class="fa fa-file-signature"></i> Générer PV</a>
                  </div>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td><input type="checkbox"></td>
              <td>002</td>
              <td>Réinscription S3</td>
              <td>Dr. Y. Messaoudi</td>
              <td>UTM/FST</td>
      ...
      <!-- TAB 2 : Suivi des recommandations -->
        ...
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              <td><input type="checkbox"></td>
              <td>001</td>
              <td>Compléter Dossier HDR – Bouzid A.</td>
              <td>20/05/2025</td>
              <td>Pr. Sami Trabelsi</td>
              <td>30/05/2025</td>
              <td><span class="badge badge-success">Traitée</span></td>
              <td>
                <div class="actions">
                  <button class="action-btn">⋮</button>
                  <div class="dropdown-menu">
            ...
            <tr>
              <td><input type="checkbox"></td>
              <td>002</td>
              <td>Revoir La Composition Du Jury</td>
              <td>03/06/2025</td>
              <td>Dr. Y. Messaoudi</td>
              <td>15/06/2025</td>
