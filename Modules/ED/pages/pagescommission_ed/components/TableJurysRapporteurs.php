  ...
  <table id="candidaturesTable" class="styled-table display" style="width:100%">
    ...
    <tbody>
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              <a href="/fiche-de-composition-d-un-jury_comissioned"><i class="fa fa-eye"></i> Consulter</a>
              <a href="#"><i class="fa fa-pen"></i> Modifier</a>
              <a href="#"><i class="fa fa-user-plus"></i> Ajouter jury</a>
            </div>
          </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td>—</td>
        <td>—</td>
        <td><span class="badge badge-warning">À confirmer</span></td>
        <td>
          <div class="actions">
            <button class="action-btn" aria-haspopup="true" aria-expanded="false">⋮</button>
            <div class="dropdown-menu">
