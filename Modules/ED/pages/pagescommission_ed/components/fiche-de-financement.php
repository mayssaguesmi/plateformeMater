...
<div class="content-wrapper">
  ...
  <!-- 2 colonnes : Informations doctorant / Détails du financement -->
  <div class="grid-container" id="dragZone">
    ...
    <div class="box" draggable="true">
      ...
      <ul>
        <li><strong>Type de financement :</strong> <span>Bourse nationale</span></li>
        <li><strong>Source :</strong> <span>MESRS</span></li>
        <li><strong>Montant mensuel :</strong> <span>1&nbsp;200&nbsp;TND</span></li>
        <li><strong>Période couverte :</strong> <span>01/10/2023 – 30/09/2026</span></li>
        <li><strong>Dispositif spécifique :</strong> <span>Non applicable</span></li>
        <li><strong>Observations :</strong> <span>–</span></li>
      </ul>
    </div>
  </div>
  ...
  <div class="card full-width" style="margin-top:20px;">
    ...
    <table class="parcours-table">
      ...
      <tbody>
        <tr>
          <td>001</td>
          <td>Attestation de financement</td>
          <td>Reçu</td>
        ...
        <tr>
          <td>003</td>
          <td>Convention de cotutelle</td>
          <td>Manquant</td>
          <td>–</td>
        </tr>
        <tr>
          <td>004</td>
          <td>Justificatif fiscal (si applicable)</td>
          <td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" alt="pdf"></a></td>
        </tr>
      </tbody>
  ...
  <!-- (Conservé tel quel, si tu souhaites le garder) Documents associés -->
