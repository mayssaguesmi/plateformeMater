...
<div class="card-grid">
  ...
  <div class="column" id="column1">
    ...
    <div class="card with-image card1" draggable="true">
      <a href="/comites-de-suivi_comissioned/"><div class="card-title">Comités De Suivi</div></a>
      <a href="/comites-de-suivi_comissioned/"><span class="corner-icon">↗</span></a>
    </div>


    <div class="card with-image card2" draggable="true">
       <a href="/jurys-rapporteurs_comissioned/"> <div class="card-title">Jurys /Rapporteurs</div></a>
      <a href="/jurys-rapporteurs_comissioned/"><span class="corner-icon">↗</span></a>
    </div>
...
.card.with-image.card1 {
    background-image: url('/wp-content/plugins/plateforme-master/imagesED/comite.png');
    background-size: 64%;
