...
<div class="card-section">
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        ...
        <select class="form-control">
          <option selected>Alternance entreprise</option>
        </select>
      </div>
      <div class="form-group">
        <label>Intitulé de la mission / projet</label>
        <input type="text" class="form-control" placeholder="ex : collecte de données, séjour, stage, recherche...">
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Encadrant / Tuteur dans la structure</label>
        <select class="form-control">
  ...
  <!-- Bloc : Période de la mobilité -->
  <div class="card-title">
    <h3>Période de la mobilité</h3>
  </div>
  <hr>
  ...
  <div class="card-content">
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Modalité de présence</label>
        <select class="form-control">
  ...
  <!-- Bloc : Informations sur la bourse -->
  <div class="card-title">
    <h3>Informations sur la bourse sollicitée</h3>
  </div>
  <hr>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        <label>Montant estimé demandé</label>
        <input type="text" class="form-control" value="8000 TND">
      </div>
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Financement complémentaire prévu ?</label>
        <div class="radio-group-custom">
          <label class="radio-btn">
            <input type="radio" name="financement_compl" checked>
            <span class="custom-radio"></span>
            Oui
          </label>
          <label class="radio-btn">
            <input type="radio" name="financement_compl">
            <span class="custom-radio"></span>
            Non
          </label>
        </div>
      ...
      <div class="form-group">
        <label>Assurance déplacement incluse ?</label>
        <div class="radio-group-custom">
          <label class="radio-btn">
            <input type="radio" name="assurance_bourse" checked>
            <span class="custom-radio"></span>
            Oui
          </label>
          <label class="radio-btn">
            <input type="radio" name="assurance_bourse">
            <span class="custom-radio"></span>
            Non, à souscrire
          </label>
        </div>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        ...
        <div class="input-upload-group">
          ...
          <label class="btn-importer"><i class="fas fa-upload"></i> Importer<input type="file" hidden></label>
        </div>
      </div>

      <div class="form-group">
        <label>Lettre d’accueil de la structure</label>
        <div class="input-upload-group">
          <input type="text" class="form-control filename-display" value="lettre_accueil.pdf" readonly>
          <label class="btn-importer"><i class="fas fa-upload"></i> Importer<input type="file" hidden></label>
        </div>
      </div>

      <div class="form-group">
        <label>CV actualisé</label>
        <div class="input-upload-group">
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Plan de travail / calendrier détaillé</label>
        <div class="input-upload-group">
          <input type="text" class="form-control filename-display" value="plan_de_travail.pdf" readonly>
          <label class="btn-importer"><i class="fas fa-upload"></i> Importer<input type="file" hidden></label>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-upload-group">
          <input type="text" class="form-control filename-display" value="attestation_insc.pdf" readonly>
          <label class="btn-importer"><i class="fas fa-upload"></i> Importer<input type="file" hidden></label>
        </div>
      </div>
       <div class="form-group"></div>
