  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      <tr>
        ...
        <td>Déposer Le Rapport Semestriel</td>
        <td>Académique</td>
        <td>20/06/2025</td>
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              <a href="#"><i class="fa fa-upload"></i> Déposer le fichier</a>
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Compléter Le Formulaire De Mobilité</td>
        <td>Projet PMO</td>
        <td>15/07/2025</td>
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Participer À La Formation "Éthique"</td>
        <td>Formation</td>
        <td>01/05/2025</td>
