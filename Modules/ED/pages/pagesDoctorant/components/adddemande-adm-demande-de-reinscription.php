<!-- Bloc : Demande de réinscription -->
<div class="card-section">
  <div class="card-title">
    <h3>Demande de réinscription</h3>
  </div>
  <hr>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        <label>Année de réinscription demandée</label>
        <select class="form-control">
          <option selected>2025-2026</option>
        </select>
      </div>
      <div class="form-group">
        <label>Directeur de thèse actuel</label>
        <select class="form-control">
          <option selected>Pr. J. Saied</option>
        </select>
      </div>
      <div class="form-group">
        <label>Situation académique</label>
        <select class="form-control">
          <option selected>En progression normale</option>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        <label>Rapport annuel (PDF)</label>
      ...
      <div class="form-group">
        <label>Attestation de paiement des frais</label>
        <div class="input-upload-group">
          <input type="text" class="form-control filename-display" value="attestation.pdf" readonly>
          <label class="btn-importer"><i class="fas fa-upload"></i> Importer<input type="file" hidden></label>
        </div>
      </div>

      <div class="form-group">
        <label>Justificatif de financement</label>
        <div class="input-upload-group">
