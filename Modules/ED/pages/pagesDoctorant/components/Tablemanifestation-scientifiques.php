  ...
  <div class="accordion-container">
    <div class="accordion-tabs">
      <button class="tab-btn active" data-tab="tab1">
        <img src="/wp-content/plugins/plateforme-master/images/ed/3655586.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;">        Manifestations Scientifiques
      </button>
      <button class="tab-btn" data-tab="tab2">
        <img src="/wp-content/plugins/plateforme-master/images/ed/3655586.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;">        Mes Participations
      </button>
    </div>

    <div class="accordion-content">

      <!-- Onglet 1 : Manifestations Scientifiques -->
      <div class="tab-panel active" id="tab1">
        <div class="table-controls">
          <div class="filter-selectgb">
            <input type="text" class="filter-input" placeholder="Recherchez...">
              ...
              <td>
                <div class="actions">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a href="#"><i class="fa fa-user-plus"></i> Participer</a>
      ...
      <!-- Onglet 2 : Mes Participations -->
      <div class="tab-panel" id="tab2">
        <div class="table-header-row">
          <h3 class="table-title">Tableau de mes participations</h3>
          <a href="/manifestation-scientifiques-mes-participations-declarer-une-participation/" class="btn-statut">Déclarer une participation</a>
        </div>
