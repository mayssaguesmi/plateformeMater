...
<div class="content-block">
  <div class="header-bar">
    <h2>Tableau de suivi de mes demandes</h2>

    <div class="dropdown" style="position: relative;">
     <button class="btn-statut" id="dropdownToggle" onclick="toggleDropdown(event)">
  Nouvelle demande <i class="fa fa-caret-down" style="margin-left: 8px;"></i>
</button>


      <div class="dropdown-menu demande-dropdown-menu" id="demandeDropdown" style="display: none; top: 110%; right: 0; position: absolute; min-width: 189px;">
        <a href="/demande-adm-demande-de-reinscription/">Réinscription</a>
        <a href="/demande-adm-changement-dencadrant/">Changement d'encadrant</a>
        <a href="#">Attestation</a>
        <a href="/demande-adm-financement/">Financement</a>
      </div>
    </div>
  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      <tr>
        ...
        <td>Réinscription Année 2024/2025</td>
        <td>01/06/2025</td>
...
<style>
  ...
  /* Menu d’entête : plus spécifique */
.dropdown .demande-dropdown-menu {
  display:none;
  position:absolute;
  top:110%;
  right:0;
...
.actions .dropdown-menu { /* menus des lignes uniquement */
  display:none;
  position:absolute;
  top:100%;
  right:0;
...
select {
  ...
  border: 1px solid #DBD9C3 !important;
  ...
  background-image: url("/wp-content/plugins/plateforme-master/images/DROPDOWN icon.png") !important;
...
/* Header "Nouvelle demande" menu */
.demande-dropdown-menu {
  z-index: 3000; /* above DataTables & cards */
  box-shadow: 0 6px 16px rgba(0,0,0,0.15);
  border: 1px solid #d8d4b7;
  border-radius: 8px;
}
...
// ---- HEADER "Nouvelle demande" dropdown ----
function toggleDropdown(e) {
  e.stopPropagation(); // don't bubble to document
  const menu = document.getElementById('demandeDropdown');
  menu.style.display = (menu.style.display === 'block') ? 'none' : 'block';
}

// Close header dropdown only if click outside
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Click outside closes ONLY the row action menus
  document.addEventListener('click', function () {
    document.querySelectorAll('.actions .dropdown-menu').forEach(menu => {
      menu.style.display = 'none';
    });
