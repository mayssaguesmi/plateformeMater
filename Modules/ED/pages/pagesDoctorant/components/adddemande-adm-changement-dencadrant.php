<!-- Bloc : Demande de changement d'encadrant -->
<div class="card-section">
  <div class="card-title">
    <h3>Demande de changement d’encadrant</h3>
  </div>
  <hr>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        <label>Ancien encadrant</label>
        <select class="form-control">
          <option selected>Pr. Hatem Ben Salem</option>
        </select>
      </div>

      <div class="form-group">
        <label>Nouveau encadrant proposé</label>
        <select class="form-control">
    ...
    <div class="form-row">
      <div class="form-group" style="flex: 1 1 100%;">
        ...
        <input type="text" class="form-control" placeholder="Saisir votre motif ici…">
      </div>
    </div>
  </div>
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group" style="flex: 1 1 100%;">
        <label>Accord signé ( facultatif )</label>
  ...
  <!-- Bloc : Commentaire complémentaire -->
  <div class="card-title">
