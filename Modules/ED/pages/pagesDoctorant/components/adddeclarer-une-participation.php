...
<div class="card-section">
  ...
  <div class="card-content">
    <div class="form-row">
      <div class="form-group">
        ...
        <input type="text" class="form-control" value="Journée Doctorale De L’ED FST">
      </div>
      <div class="form-group">
        <label>Type</label>
    ...
    <div class="form-row">
      <div class="form-group">
        <label>Lieu</label>
        <input type="text" class="form-control" value="FST _ Amphi 1">
      </div>
      <div class="form-group">
  ...
  <div class="card-content">
    <div class="form-row">
      ...
      <div class="form-group">
        <label>Programme officiel (facultatif)</label>
        <div class="input-upload-group">
