<div class="content-block">
  <div class="accordion-container">
    <div class="accordion-tabs">
      <button class="tab-btn active" data-tab="tab1"><img src="/wp-content/plugins/plateforme-master/images/ed/5326531.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;"> État de la thèse</button>
      <button class="tab-btn" data-tab="tab2"><img src="/wp-content/plugins/plateforme-master/images/ed/4185473.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;">Encadrants</button>
      <button class="tab-btn" data-tab="tab3"><img src="/wp-content/plugins/plateforme-master/images/ed/report-document-file.png" alt="Icon" style="width: 33px;height: 33px; margin-right: 8px; vertical-align: middle;">Rapports de progression</button>
    </div>

    <div class="accordion-content">
      <!-- Onglet 1 : État de la thèse -->
      <div class="tab-panel active" id="tab1">
         <table class="etat-these-table">
          <tbody>
            <tr>
              <td>Statut actuel :</td>
              <td><span class="etat-badge etat-en-cours"><i class="dot"></i> En cours</span></td>
            </tr>
            <tr>
              <td>Inscription initiale :</td>
              <td>01/11/2022</td>
            </tr>
            <tr>
              <td>Année actuelle :</td>
              <td>3ᵉ année</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Soutenance prévue :</td>
              <td>15/10/2025 <em>(non confirmée)</em></td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              ...
              <td>Faculté des Sciences de Tunis (FST)</td>
              <td>mohamed.trabelsi@fst.utm.tn</td>
              <td>"Poursuivre la rédaction de l'article 2."</td>
            </tr>
            <tr>
              <td>Dr. Julie Morel</td>
              <td>Co-encadrante (cotutelle)</td>
              <td>Université Lyon 1</td>
              <td>julie.morel@univ-lyon1.fr</td>
              <td>"Prochaine réunion prévue le 28/06."</td>
            </tr>
          </tbody>
        </table>
      </div>

      <!-- Onglet 3 : Rapports de progression -->
      <div class="tab-panel" id="tab3">
        <div class="d-flex justify-content-end mb-3">
          <a href="#" onclick="openmodalObjectifs()" class="btn-statut">Déposer</a>
        </div>
        <table class="styled-table">
          <thead>
            <tr>
              ...
              <th>Période</th>
              <th>Date de dépôt</th>
              <th>Commentaire de l’ED ou du jury</th>
              <th>Statut</th>
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td>Rapport Annuel 2023–2024</td>
              <td>01/10/2023 – 30/06/2024</td>
              <td>30/06/2025</td>
              <td>“Bon Avancement”.</td>
              ...
              <td>
                <div class="actions">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a href="#"><i class="fa fa-upload"></i> Déposer</a>
                  </div>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td><input type="checkbox"></td>
              <td>Rapport S1</td>
              <td>01/10/2025 – 28/02/2025</td>
              <td>01/05/2025</td>
              <td>“À Approfondir Les Résultats.”</td>
              <td><span class="badge badge-success">Validé</span></td>
              <td>
                <div class="actions">
                  <button class="action-btn">⋮</button>
