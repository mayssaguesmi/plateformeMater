<div class="content-block">
  <div class="header-bar">
    <h2>Liste Des Appels Ouverts</h2>
  </div>
  ...
  <div class="filter-bar">
    <div class="filter-selectgb">
      ...
      <select class="filter-select">
        ...
        <option>Financement Doctoral</option>
      </select>
    </div>
  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      <tr>
        ...
        <td>CMCU Tunisie-France 2025</td>
        <td>Mobilité</td>
        <td>30/06/2025</td>
        <td>1 200 €/Mois</td>
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              <a href="#"> Voir</a>
              <a href="/appel-a-projets-postuler/">Postuler</a>
            </div>
          </div>
        </td>
      </tr>
      <tr>
        <td><input type="checkbox"></td>
        <td>Appel Projets Doctorants USCR</td>
        <td>Projet De Recherche</td>
        <td>15/07/2025</td>
        <td>8 000 TND</td>
        <td><span class="badge badge-danger">Clos</span></td>
        <td>
          <div class="actions">
            <button class="action-btn">⋮</button>
            <div class="dropdown-menu">
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Bourse Excellence MESRS</td>
        <td>Financement Doctoral</td>
        <td>01/05/2025</td>
        <td>100 % Thèse</td>
