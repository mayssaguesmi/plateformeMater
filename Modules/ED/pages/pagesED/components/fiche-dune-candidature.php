<div class="status-bar-container">
  <div class="status-header d-flex justify-content-between align-items-center">
    <h2>Statut de demande</h2>
    <div class="d-flex align-items-center gap-2">
      <button class="btn btn-outline-danger">
         Télécharger le dossier
      </button>
      <button class="btn btn-danger">
         Envoyer confirmation au partenaire
      </button>
    </div>
  </div>
</div>
...
<div class="grid-container" id="dragZone">
  ...
  <div class="box">
    ...
    <ul>
      <li><strong>Nom & Prénom :</strong> Farah Yassir</li>
      <li><strong>Email :</strong> farah.yassir@ul.edu.lb</li>
      <li><strong>Nationalité :</strong> Libanaise</li>
      <li><strong>Téléphone :</strong> +961 71 456 321</li>
      <li><strong>Pays d’origine :</strong> Liban</li>
      <li><strong>Num passeport :</strong> 452116L</li>
    </ul>
  </div>
  ...
  <div class="box">
    ...
    <ul>
      <li><strong>Dernier diplôme obtenu :</strong> Master en Biologie moléculaire</li>
      <li><strong>Établissement :</strong> Université Libanaise – Faculté des Sciences</li>
      <li><strong>Année d’obtention :</strong> 2023</li>
      <li><strong>Spécialité demandée :</strong> Biologie cellulaire et génétique</li>
      <li><strong>Directeur de thèse proposé :</strong> Pr. Sana Ghannouchi</li>
    </ul>
  </div>
  ...
  <div class="box full-width">
    ...
    <table class="parcours-table">
      ...
      <tbody>
        <tr>
          <td>Diplôme Master + Traduction</td><td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
        </tr>
        <tr>
          <td>Attestation de langue (TCF B2)</td><td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
        </tr>
        <tr>
          <td>Copie passeport</td><td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
        </tr>
        <tr>
          <td>Lettre de motivation</td><td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
        </tr>
        <tr>
          <td>Lettre d’acceptation de l’encadrant</td><td>Manquant</td>
          <td>—</td>
        </tr>
        <tr>
          <td>Visa étudiant</td><td>Reçu</td>
          <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
        </tr>
      </tbody>
    </table>
  ...
  <!-- Bloc Suivi administratif -->
  <div class="box full-width">
    <h3>Suivi administratif</h3>
    <table class="parcours-table">
      <tbody>
        <tr><td><strong>Statut de la demande :</strong></td><td>En attente</td></tr>
        <tr><td><strong>Date de dépôt :</strong></td><td>03 avril 2025</td></tr>
        <tr><td><strong>Date prévisionnelle de démarrage :</strong></td><td>01 octobre 2025</td></tr>
        <tr><td><strong>Équivalence validée :</strong></td><td>oui</td></tr>
        <tr><td><strong>Statut légal :</strong></td><td>En attente de visa étudiant</td></tr>
      </tbody>
    </table>
  </div>
...
.card.full-width .form-group label {
  font-weight: 600;
  font-size: 14px;
  color: #2A2916;
  margin-bottom: 6px;
...
.card.full-width .form-group textarea {
  width: 100%;
  min-height: 80px;
