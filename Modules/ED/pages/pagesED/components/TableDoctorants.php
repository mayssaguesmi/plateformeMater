  ...
  <table id="candidaturesTable" class="styled-table display">
    ...
    <tbody>
      <tr>
        ...
        <td>Optimisation Des Réseaux Sans Fil</td>
        <td>Dr. H. Gharbi</td>
        <td>2<sup>e</sup></td>
      ...
      <tr>
        <td><input type="checkbox"></td>
        <td>Fatma Jouini</td>
        <td>IA Pour Le Diagnostic Médical</td>
        <td>Pr. R. Mzoughi</td>
        <td>3<sup>e</sup></td>
        <td><span class="badge badge-danger">Radié</span></td>
        <td>0%</td>
        <td>
          <div class="actions">
            <button class="action-btn">⋮</button>
      ...
      <tr>
        ...
        <td>Systèmes Autonomes Pour Drones</td>
        <td>Dr. S. Kallel</td>
        <td>1<sup>e</sup></td>
        <td><span class="badge badge-success">Inscrit</span></td>
        <td>67%</td>
