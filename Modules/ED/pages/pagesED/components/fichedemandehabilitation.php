  ...
  <div class="status-header d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-2">
      <button class="btn btn-outline-danger">
        <i class="fas fa-file-download" style="margin-right: 5px;"></i> Télécharger le dossier
      </button>
      <div class="dropdown status-select" id="status-select-dossier">
        <button class="btn btn-light dropdown-toggle" type="button" id="dropdownStatutInscription" data-bs-toggle="dropdown" aria-expanded="false">
          Validée
        </button>
        <ul class="dropdown-menu" aria-labelledby="dropdownStatutInscription">
          <li><a class="dropdown-item" href="#">En cours d'examen</a></li>
          <li><a class="dropdown-item" href="#">Validée</a></li>
          <li><a class="dropdown-item" href="#">Refusée</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="grid-container" id="dragZone">
  <div class="box" draggable="true">
    ...
    <ul>
      ...
      <li><strong>Grade :</strong> Professeur</li>
      <li><strong>Établissement :</strong> FST</li>
      <li><strong>Discipline :</strong> Informatique</li>
      <li><strong>Spécialité :</strong> Intelligence Artificielle</li>
      <li><strong>Email institutionnel :</strong> a.mabrouk@fst.utm.tn</li>
    </ul>
  </div>

  <div class="box" draggable="true">
    <h3>Dossier de demande</h3>
    <ul>
      <li><strong>Date de dépôt :</strong> 10-03-2025</li>
      <li><strong>Commission responsable :</strong> Commission doctorale n°3</li>
      <li><strong>Statut actuel :</strong> En cours d'examen</li>
    </ul>
  </div>
</div>
...
<div class="card full-width">
  ...
  <table class="parcours-table">
    ...
    <tbody>
      <tr>
        <td>CV détaillé</td><td>Reçu</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
      <tr>
        <td>Liste des publications</td><td>Reçu</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
      <tr>
        <td>Rapport scientifique HDR</td><td>Reçu</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
      <tr>
        <td>Attestation d’exercice</td><td>Reçu</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
    </tbody>
  </table>
...
<div class="card full-width">
  ...
  <table class="parcours-table">
    ...
    <tbody>
      ...
      <tr>
        <td>12/04/2025</td>
        <td>Transmission à la commission</td>
        <td>ED FST</td>
        <td>Commission 3 assignée</td>
      </tr>
      <tr>
        <td>14/04/2025</td>
