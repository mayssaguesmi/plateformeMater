...
<div class="grid-container" id="dragZone">
  ...
  <div class="box">
    ...
    <ul>
      <li><strong>Nom & Prénom :</strong> Pr. Ahmed Mabrouk</li>
      <li><strong>Email :</strong> a.bouzid@fst.utm.tn</li>
      <li><strong>Thèse soutenue le :</strong> 15/12/2024</li>
      <li><strong>Spécialité :</strong> Chimie Analytique</li>
      <li><strong>Encadrant de thèse :</strong> Pr. Leila Mahfoudh</li>
      <li><strong>Sujet de thèse :</strong> Développement de méthodes électrochimiques pour l’analyse des métaux lourds dans l’eau potable</li>
    </ul>
  </div>

  <!-- Bloc Partenaire d’accueil post-doc -->
  <div class="box">
    <h3>Partenaire d’accueil post-doc</h3>
    <ul>
      <li><strong>Organisme :</strong> Université Claude Bernard Lyon 1</li>
      <li><strong>Pays :</strong> France</li>
      <li><strong>Laboratoire :</strong> UMR CNRS 5180 - LAGEPP</li>
      <li><strong>Contact :</strong> Dr. Jean-Luc Renaud</li>
      <li><strong>Email partenaire :</strong> jeanluc.renaud@univ-lyon1.fr</li>
    </ul>
  </div>

  <!-- Bloc Contrat post-doc proposé -->
  <div class="box">
    <h3>Contrat post-doc proposé</h3>
    <ul>
      <li><strong>Statut du contrat :</strong> Signé</li>
      <li><strong>Date de début :</strong> 01/03/2025</li>
      <li><strong>Date de fin :</strong> 01/03/2026</li>
      <li><strong>Durée :</strong> 12 mois</li>
      <li><strong>Financement :</strong> Programme bilatéral CMCU Tunisie-France</li>
      <li><strong>Rémunération mensuelle :</strong> 1 500 € net/mois</li>
    </ul>
  </div>
...
<div class="box">
  ...
  <table class="parcours-table">
    ...
    <tbody>
      ...
      <tr>
        <td>Projet d’accueil (partenaire)</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
      <tr>
        <td>Contrat signé (version finale)</td>
        <td><a href="#"><img class="pdf-icon" src="/imagesMaster/servicemaster_images/pdf-svgrepo-com (2).png" /></a></td>
      </tr>
    </tbody>
  </table>
...
<div class="card full-width">
  <h3>Commentaire interne de l’ED</h3>
  <p>Dossier très complet. Signature validée par le partenaire le 26 février 2025.<br>
  Ajouter au tableau de suivi annuel 2025/2026.</p>
</div>
