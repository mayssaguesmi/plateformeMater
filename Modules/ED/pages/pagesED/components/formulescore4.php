<div class="body-content">
        ...
        <ul class="utm-toggle-list">
                ...
                <div class="utm-toggle-content" id="bloc-l1">
                    ...
                    <div class="utm-average-section">
                        <!--<div class="utm-average-inputs">
                            <input type="text" name="moyenneInputs[]" placeholder="Moyenne générale" readonly>
                            <input type="text" name="moyenneInputs[]" placeholder="Nombre total d'années" readonly>
                        </div>-->
            ...
            <div class="utm-toggle-content" id="bloc-entretien">
                <input type="number" name="inputEntretien" id="inputEntretien" placeholder="Note d'entretien" value="16">
            </div>
            </li>-->
