<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <span class="label">Budget engagé</span>
        <span class="value">36 TND</span>
      </div>
      <div class="stat-box">
        <span class="label">Structures d’accueil partenaires</span>
...
<script>
const labels = ['Demandes En Cours', 'Demandes Refusées', 'Bourses accordées'];
