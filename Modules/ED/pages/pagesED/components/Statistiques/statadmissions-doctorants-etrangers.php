<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <span class="label">Candidatures étrangères</span>
        <span class="value">36</span>
      </div>
      <div class="stat-box">
        <span class="label">Pays représentés</span>
...
<script>
const labels = ['Candidats Admis', 'Dossiers En Attente De Visa', 'Candidatures refusées'];
const dataValues = [66, 10, 24];
const colors = ['#808066', '#dabebe', '#b1342f'];
