<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    <div class="left-stats">
     ...
     <div class="stat-box">
      <span class="label">Total de doctorants</span>
      <span class="value">108</span>
    </div>
    <div class="stat-box">
      <span class="label">Formations proposées<br>ce semestre</span>
...
<script>
const labels = ['Doctorants À Jour', 'En Cours De Validation', 'Sans crédits'];
const dataValues = [66, 24, 10];

const colors = ['#808066', '#b1342f', '#dabebe']; // mêmes couleurs que la maquette
