<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    ...
    <div class="left-stats">
      <div class="stat-box">
        <span class="label">
          Pays partenaires impliqués
        </span>
        <span class="value">9</span>
      </div>
      <div class="stat-box">
        <span class="label">Doctorants en mobilité actuellement
...
<script>
const labels = ['Conventions Signé', 'Conventions Refusé', 'En attente']
const dataValues = [66, 10, 24]; // % valeurs fictives
