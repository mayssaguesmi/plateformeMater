<div class="statistiques-wrapper">
  ...
  <div class="stats-grid">
    <div class="left-stats">
      <div class="stat-box">
        <span class="label">Total doctorants inscrits</span>
        <span class="value">21</span>
      </div>
      <div class="stat-box">
        <span class="label">Total doctorants Radiés</span>
...
<script>
const labels = ['Informatique', 'Biotechnologie', 'Autres'];
const dataValues = [66, 24, 10];
const colors = ['#808066', '#dabebe', '#b1342f']; // Couleurs conformes à l’image
