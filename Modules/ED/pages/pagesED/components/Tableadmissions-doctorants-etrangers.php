<div class="content-block">
  <div class="header-bar">
    <h2>
      ...
      Tableau de suivi des candidatures étrangères
        ...
        <td>
          <div class="actions">
            ...
            <div class="dropdown-menu">
              <a href="/fiche-dune-candidature/"><i class="fa fa-eye"></i> Consulter</a>
              <a href="#"><i class="fa fa-check"></i> Valider</a>
              <a href="#"><i class="fa fa-file-alt"></i> Générer attestation</a>
            </div>
          </div>
        </td>
      </tr>
