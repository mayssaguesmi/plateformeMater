...
add_action('rest_api_init', function () {
  register_rest_route('plateforme/v1', '/reclamations', [
    'methods'             => 'POST',
    'permission_callback' => function(){ return is_user_logged_in(); }, // durci: user connecté + nonce REST
...
function pm_rest_list_reclamations( WP_REST_Request $req ){
  ...
  if (!$uid) {
    return new WP_REST_Response(['data'=>[], 'pagination'=>['total'=>0,'page'=>1,'per_page'=>10,'pages'=>0]], 200);
  }
